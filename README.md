...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,173 | 🐛 106 | 📅 2026-09-02
...
* How to use MobX with
  [Create React App](https://github.com/facebookincubator/create-react-app) ⭐ 103,255 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15:
  * Without ejecting, by using
    [react-app-rewired](https://github.com/timarney/react-app-rewired/tree/master/packages/react-app-rewire-mobx) ⭐ 9,838 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-13
  * Or,
...
* [GitHub Repo](https://github.com/mobxjs/mobx) ⭐ 28,213 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22
* [Release Notes](https://github.com/mobxjs/mobx/blob/master/CHANGELOG.md) ⭐ 28,213 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22
...
* [Mobx-React-Devtools](https://github.com/mobxjs/mobx-react-devtools) ⭐ 1,221 | 🐛 18 | 🌐 JavaScript | 📅 2019-05-31 - deprecated for `mobx-react@^6`, `react@^16`
...
* [Importing store directly or pass as props?](https://github.com/mobxjs/mobx/issues/300) ⭐ 28,213 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22
...
* [Understanding MobX versus Redux](https://www.youtube.com/watch?v=83v8cdvGfeA)
  (related thread: <https://github.com/mobxjs/mobx/issues/199> ⭐ 28,213 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22)
* [Free Egghead.io course: Manage Complex State in React Apps with MobX](https://egghead.io/courses/manage-complex-state-in-react-apps-with-mobx)
...
* [Understanding MobX and when to use it (Github issue)](https://github.com/mobxjs/mobx/issues/199) ⭐ 28,213 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-22
...
* [SaaS Boilerplate](https://github.com/async-labs/saas) ⭐ 4,514 | 🐛 20 | 🌐 TypeScript | 📅 2025-03-21 - Open source boilerplate app to build your own SaaS product.
...
* [Next.js with MobX](https://github.com/zeit/next.js/tree/master/examples/with-mobx) ⭐ 142,414 | 🐛 3,463 | 🌐 JavaScript | 📅 2026-09-23
  ![staff pick](https://img.shields.io/badge/-MobX%20Staff%20Pick-orange.svg)
...
* [Simple drag and drop application. Also provides time travelling](https://github.com/mobxjs/mobx-reactive2015-demo) ⭐ 96 | 🐛 2 | 🌐 JavaScript | 📅 2016-08-16
...
* The
  [ports of the *Notes* and *Kanban* examples](https://github.com/survivejs/mobx-demo) ⭐ 82 | 🐛 0 | 🌐 JavaScript | 📅 2017-08-07
...
* [custom-react-scripts](https://www.npmjs.com/package/custom-react-scripts) for
  [create-react-app](https://github.com/facebookincubator/create-react-app) ⭐ 103,255 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 that
...
* [react-mobx-typescript-boilerplate](https://github.com/rokoroku/react-mobx-typescript-boilerplate) ⭐ 379 | 🐛 27 | 🌐 TypeScript | 📅 2023-01-06
...
* [mobx-react-intl](https://github.com/Sqooba/mobx-react-intl) ⚠️ Archived
  ...
  [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,745 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-23
...
* [mobx-state-tree](https://github.com/mobxjs/mobx-state-tree/) ⭐ 7,053 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-02 Opinionated,
  transactional, MobX powered state container
* [mobx-keystone](https://github.com/xaviergonz/mobx-keystone) ⭐ 623 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-16 Opinionated, transactional, MobX powered state container with first-class Typescript support
