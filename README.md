...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,114 | 🐛 106 | 📅 2026-09-02
...
* How to use MobX with
  [Create React App](https://github.com/facebookincubator/create-react-app) ⭐ 103,270 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15:
...
* [Next.js with MobX](https://github.com/zeit/next.js/tree/master/examples/with-mobx) ⭐ 142,096 | 🐛 3,282 | 🌐 JavaScript | 📅 2026-09-05
  ![staff pick](https://img.shields.io/badge/-MobX%20Staff%20Pick-orange.svg)
...
* [custom-react-scripts](https://www.npmjs.com/package/custom-react-scripts) for
  [create-react-app](https://github.com/facebookincubator/create-react-app) ⭐ 103,270 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 that
...
* [mobx-react-intl](https://github.com/Sqooba/mobx-react-intl) ⚠️ Archived
  ...
  [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,748 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-05
...
* [mobx-keystone](https://github.com/xaviergonz/mobx-keystone) ⭐ 622 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-04 Opinionated, transactional, MobX powered state container with first-class Typescript support
