...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,860 | 🐛 100 | 📅 2026-06-30
...
* How to use MobX with
  [Create React App](https://github.com/facebookincubator/create-react-app) ⭐ 103,312 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15:
...
* [Next.js with MobX](https://github.com/zeit/next.js/tree/master/examples/with-mobx) ⭐ 141,773 | 🐛 4,228 | 🌐 JavaScript | 📅 2026-08-15
  ![staff pick](https://img.shields.io/badge/-MobX%20Staff%20Pick-orange.svg)
...
* [custom-react-scripts](https://www.npmjs.com/package/custom-react-scripts) for
  [create-react-app](https://github.com/facebookincubator/create-react-app) ⭐ 103,312 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 that
...
* [mobx-react-intl](https://github.com/Sqooba/mobx-react-intl) ⚠️ Archived
  ...
  [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,742 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-14
...
* [mobx-state-tree](https://github.com/mobxjs/mobx-state-tree/) ⭐ 7,051 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-05 Opinionated,
  transactional, MobX powered state container
* [mobx-keystone](https://github.com/xaviergonz/mobx-keystone) ⭐ 616 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-13 Opinionated, transactional, MobX powered state container with first-class Typescript support
