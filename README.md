...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,783 | 🐛 106 | 📅 2026-09-02
...
* How to use MobX with
  [Create React App](https://github.com/facebookincubator/create-react-app) ⭐ 103,254 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15:
...
* [GitHub Repo](https://github.com/mobxjs/mobx) ⭐ 28,211 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22
* [Release Notes](https://github.com/mobxjs/mobx/blob/master/CHANGELOG.md) ⭐ 28,211 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22
...
* [Importing store directly or pass as props?](https://github.com/mobxjs/mobx/issues/300) ⭐ 28,211 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22
...
* [Understanding MobX versus Redux](https://www.youtube.com/watch?v=83v8cdvGfeA)
  (related thread: <https://github.com/mobxjs/mobx/issues/199> ⭐ 28,211 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22)
* [Free Egghead.io course: Manage Complex State in React Apps with MobX](https://egghead.io/courses/manage-complex-state-in-react-apps-with-mobx)
...
* [Understanding MobX and when to use it (Github issue)](https://github.com/mobxjs/mobx/issues/199) ⭐ 28,211 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22
...
* [Next.js with MobX](https://github.com/zeit/next.js/tree/master/examples/with-mobx) ⭐ 142,396 | 🐛 3,472 | 🌐 JavaScript | 📅 2026-09-22
  ![staff pick](https://img.shields.io/badge/-MobX%20Staff%20Pick-orange.svg)
...
* [custom-react-scripts](https://www.npmjs.com/package/custom-react-scripts) for
  [create-react-app](https://github.com/facebookincubator/create-react-app) ⭐ 103,254 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 that
...
* [mobx-react-intl](https://github.com/Sqooba/mobx-react-intl) ⚠️ Archived
  ...
  [react-intl](https://github.com/yahoo/react-intl) ⭐ 14,745 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-22
